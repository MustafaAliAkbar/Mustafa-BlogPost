...
export default function Home() {
    return (
        <div className='text-white'>
            ...
            <div className='relative w-full' style={{ height: 'calc(100vh - 4rem - 5rem)' }}>
                <div className='mirrored-background flex flex-col md:flex-row items-start justify-between px-4 md:px-20 relative' style={{ height: 'calc(100vh - 4rem - 5rem)' }}>
                    <div className='w-full md:px-20 xl:px-40 xxl:px-40 py-4 flex flex-col md:flex-row justify-between space-x-0 md:space-x-16 absolute top-[-130px] left-2 right-2'>
                        ...
                        <div className='flex justify-center py-8 xl:px-16 z-[1]' >
                            <div
                    ...
                    <div className='absolute mx-auto bottom-10 px-8 md:px-24 z-[5]'>
